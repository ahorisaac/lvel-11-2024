    ...
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name-input" name="name" placeholder="Ex: Taylor Otwell"
            ...
            {{-- confirm password --}}
            <div class="mb-6">
                <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm
                    Password</label>
